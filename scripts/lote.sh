...
PAGES_DIR="pdfs/images/doces_vo_elisa"

# Diretório de saída
OUT_DIR="/Users/leonardomontero/Documents/GitHub/blog/projects/receitas/doces-vo-elisa"
...
for PAGES in "$PAGES_DIR"/*; do
    ...
    python src/main.py extract-text --images "$PAGES" --out "$OUT_DIR/$PAGE_NAME"
    sleep 30
done